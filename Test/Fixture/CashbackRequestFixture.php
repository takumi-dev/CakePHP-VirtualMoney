<?php
/**
 * CashbackRequestFixture
 *
 */
App::uses('CashbackRequest', 'VirtualMoney.Model');
class CashbackRequestFixture extends CakeTestFixture {
 ...
 * @var array
 */
	public $import = array('model' => 'VirtualMoney.CashbackRequest');
